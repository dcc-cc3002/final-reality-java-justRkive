...
public class Main {
    ...
    public static void main(String[] args) throws InvalidStatValueException {
        ...
        /**
         * equals and hashcode functionality
         */
        ...
        for (int i = 0; i < 6; i++) {
            ...
            else System.out.println(party.get(i).equals(party.get(0)));
